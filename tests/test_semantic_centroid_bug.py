...
`atlas_kit.semantic` — this pins the contract a later phase implements
against. Do not implement them here.
"""
from __future__ import annotations

from atlas_kit.providers.base import l2_normalize
from atlas_kit.semantic import DEFAULT_MIN_SCORE, cosine
...
def test_recentre_removes_shared_domain_bias():
    ...
    RED on purpose -- `centroid`/`recentre` don't exist in atlas_kit.semantic
    ...
    from atlas_kit.semantic import centroid, recentre  # noqa: expected to fail today (ImportError/AttributeError)
